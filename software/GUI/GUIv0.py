...
station_PL_Label = ttk.Label(content, text='Photolithography')
...
station_SC_Label = ttk.Label(content, text='Spin Coating')
...
station_Sp_Label = ttk.Label(content, text='Sputtering')
...
toolbar_Date.grid(column=13, columnspan=2, row=0, sticky='ne')
